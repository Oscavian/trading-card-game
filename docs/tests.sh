...
# --------------------------------------------------
echo -e '\033[1;32m1) Create Users (Registration)\033[0m'
echo Create User
...
echo --------------------------------------------------
echo -e '\033[1;32m2) Login Users\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m3) create packages (done by "admin")\033[0m'
curl -i -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"Id\":\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"Name\":\"WaterGoblin\", \"Damage\": 30.0}, {\"Id\":\"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"Name\":\"Dragon\", \"Damage\": 60.0}, {\"Id\":\"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"Name\":\"WaterSpell\", \"Damage\": 60.0}, {\"Id\":\"1cb6ab86-bdb2-47e5-b6e4-68c5ab389334\", \"Name\":\"Ork\", \"Damage\": 45.0}, {\"Id\":\"dfdd758f-649c-40f9-ba3a-8657f4b3439f\", \"Name\":\"FireSpell\",    \"Damage\": 25.0}]"
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m4) acquire packages kienboec\033[0m'
...
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d ""
echo;
echo -e '\033[1;32mshould fail (no money):\033[0m'
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d ""
echo;
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m5) acquire packages altenhof\033[0m'
...
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo;
echo -e '\033[1;32mshould fail (no package):\033[0m'
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo;
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m6) add new packages\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m7) acquire newly created packages altenhof\033[0m'
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo;
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m8) show all acquired cards kienboec\033[0m'
curl -i -X GET http://localhost:10001/cards --header "Authorization: Bearer kienboec-mtcgToken"
echo -e '\033[1;32mshould fail (no token)\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m9) show all acquired cards altenhof\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m10) show unconfigured deck\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m11) configure deck\033[0m'
...
echo;
echo;
echo -e '\033[1;32mshould fail ... only 3 cards set\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m12) show configured deck\033[0m'
curl -i -X GET http://localhost:10001/decks --header "Authorization: Bearer kienboec-mtcgToken"
echo;
curl -i -X GET http://localhost:10001/decks --header "Authorization: Bearer altenhof-mtcgToken"
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m13) show configured deck different representation\033[0m'
echo kienboec
...
echo --------------------------------------------------
echo -e '\033[1;32m14) edit user data\033[0m'
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m15) stats\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m16) scoreboard\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m17) battle\033[0m'
echo -e '\033[1;32mkienboec battle\033[0m'
curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer kienboec-mtcgToken" &
sleep 3;
echo -e '\033[1;32maltenhof battle\033[0m';
...
echo --------------------------------------------------
echo -e '\033[1;32m18) Stats\033[0m'
echo kienboec
curl -i -X GET http://localhost:10001/stats --header "Authorization: Bearer kienboec-mtcgToken"
echo;
echo altenhof
...
echo --------------------------------------------------
echo -e '\033[1;32m19) scoreboard\033[0m'
curl -i -X GET http://localhost:10001/scores --header "Authorization: Bearer kienboec-mtcgToken"
echo;
echo;
...
echo --------------------------------------------------
echo -e '\033[1;32m20) trade\033[0m'
...
echo --------------------------------------------------
echo -e '\033[1;32m21) check trading deals\033[0m'
curl -i -X GET http://localhost:10001/tradings  --header "Authorization: Bearer kienboec-mtcgToken"
echo;
curl -i -X POST http://localhost:10001/tradings --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "{\"Id\": \"6cd85277-4590-49d4-b0cf-ba0a921faad0\", \"CardToTrade\": \"1cb6ab86-bdb2-47e5-b6e4-68c5ab389334\", \"Type\": \"monster\", \"MinimumDamage\": 15}"
echo check trading deals
...
echo -e '\033[1;32mtry to trade with yourself (should fail)\033[0m'
...
echo -e '\033[1;32mthis is approx a sleep\033[0m'
ping localhost -n 100 &> /dev/null
